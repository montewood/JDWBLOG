...
<h3>Implementation converted to Pytorch from [this](https://www.kaggle.com/dimitreoliveira/cassava-leaf-supervised-contrastive-learning) amazing notebook </h3>
